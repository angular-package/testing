...
export { TESTING_DATE } from './date.const';
...
export { TESTING_NULL } from './null.const';
...
export { TESTING_OBJECT } from './object.const';

export { TESTING_REGEXP } from './regexp.const';
...
export { TESTING_SYMBOL_NUMBER, TESTING_SYMBOL_STRING } from './symbol.const';

export { TESTING_UNDEFINED } from './undefined.const';
