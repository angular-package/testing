// Class.
import { TestingItToBeArrayOf, TestingItToBeInstanceOf } from "./main";
...
// // Create an instance of the combined class
// const combinedInstance = new Classes();
...
// // REVIEW:
// // Mixin function: combining multiple class constructors into one
// function mixin<T extends Constructor<any>[]>(...classes: T) {
//   return classes.reduce((acc, currClass) => (
//     class extends acc {
//       constructor(...args: any[]) {
//         super(...args);
...
// // Create an instance of the combined class
// const combinedInstance = new MixedClass();
// console.log(`MixedClass`, MixedClass.toString(), combinedInstance);
