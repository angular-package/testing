...
if (execute) {
  const t = new Testing(
    executeDescribe|| Execute.describe.expectation["testing-to-be-instanceof"],
    executeIt || Execute.it.expectation["testing-to-be-instanceof"]
  );
  
  const ti = new TestingExpectToBeInstanceOf();
